				...
				<div className="w-full max-w-[390px]">
					...
					{step === 'email' && (
						<form onSubmit={handleEmailContinue}>
							...
							<button
								type="submit"
								className="w-full h-14 rounded-full bg-[#EA580C] hover:bg-[#C2410C] active:bg-[#2535A0] text-white font-semibold text-[0.9375rem] transition-colors mb-5"
							>
								Continue
							</button>
							...
							<p className="text-center text-[0.875rem] text-[#5B616E] mb-4">
								...
								<Link to="/signup" className="text-[#EA580C] hover:underline font-medium">
									Sign up
								</Link>
							</p>
						...
						<form onSubmit={handlePasswordContinue}>
							...
							<div className="mb-2">
								...
								<div className="relative">
									<input
										...
										className="w-full h-14 px-4 pr-12 rounded-xl bg-[#1E2025] border border-[#2C2F36] text-white placeholder:text-[#5B616E] text-[0.9375rem] outline-none focus:border-[#EA580C] transition-colors"
									/>
									<button
										type="button"
							...
							<div className="mb-6">
								<Link
									to="/forgot-password"
									state={{ email }}
									className="text-[0.875rem] text-[#EA580C] hover:underline font-medium"
								>
									Forgot password?
								</Link>
							</div>
							...
							<button
								type="submit"
								className="w-full h-14 rounded-full bg-[#EA580C] hover:bg-[#C2410C] active:bg-[#2535A0] text-white font-semibold text-[0.9375rem] transition-colors"
							>
								Continue
							</button>
						</form>
