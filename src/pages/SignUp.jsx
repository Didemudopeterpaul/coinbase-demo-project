	...
	return (
		<div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
			<div className="flex flex-col items-center">
				<div className="mb-8">
					<div className="w-32 h-32 rounded-full bg-[#EA580C] flex items-center justify-center mx-auto">
						<svg width="72" height="72" viewBox="0 0 48 48" fill="none">
							<rect x="12" y="8" width="24" height="32" rx="2" fill="white" fillOpacity="0.9" />
							<rect x="16" y="16" width="16" height="2" rx="1" fill="#EA580C" />
							<rect x="16" y="22" width="16" height="2" rx="1" fill="#EA580C" />
							<rect x="16" y="28" width="8" height="2" rx="1" fill="#EA580C" />
	...
	return (
		<div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
			<div className="flex flex-col items-center">
				...
				<button className="w-64 h-14 rounded-full bg-[#EA580C] hover:bg-[#C2410C] text-white font-bold text-lg" onClick={onRetry}>Try Again</button>
			</div>
		</div>
	);
}
		...
		<div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
			<div className="w-full max-w-lg mx-auto">
				...
				<div className="flex flex-col items-center bg-[#16181C] rounded-xl border border-[#23262B] py-10 px-6 mb-8">
					...
					<button className="w-48 h-12 rounded-full bg-[#EA580C] hover:bg-[#C2410C] text-white font-semibold text-lg" onClick={() => fileInputRef.current && fileInputRef.current.click()}>Browse files</button>
				</div>
				<div className="mb-8">
		...
		<div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
			<div className="w-full max-w-lg mx-auto">
				...
				<div className="flex flex-col gap-4">
					<button className="w-full h-14 rounded-full bg-[#EA580C] hover:bg-[#C2410C] text-white font-bold text-lg" onClick={onConfirm}>Yes, looks good</button>
		...
		<div className="flex flex-col items-center justify-center min-h-[60vh]">
			<div className="mb-8">
				...
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240" width="120" height="120" aria-hidden="true">
					<g>
						<circle cx="120" cy="120" r="64" fill="#EA580C" />
	...
	<button
		...
		className={`w-full h-14 rounded-full font-semibold text-[0.9375rem] transition-colors
			${disabled
				...
				: 'bg-[#EA580C] hover:bg-[#C2410C] active:bg-[#2535A0] text-white cursor-pointer'
			}`}
	>
		{children}
	</button>
